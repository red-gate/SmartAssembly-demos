...
namespace SmartAssembly.SmartExceptionsWithUI
{
	...
	internal class SecurityExceptionForm : Form
    {
        ...
        private HeaderControl headerControl = new HeaderControl(string.Format(Localization.SecurityExceptionHeader, ApplicationName));
		...
		public SecurityExceptionForm(SecurityExceptionEventArgs securityExceptionEventArgs)
		{
			...
			else
			{
				...
				sb.Append(string.Format(Localization.SecurityExceptionMessage, ApplicationName));
